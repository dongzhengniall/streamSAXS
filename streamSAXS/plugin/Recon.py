...
class GenSino(ProcessingFunction):
    ...
    def __init__(self):
        ...
        self._params_dict["X"] = {"type": "int", "value": 71, "text": "X"}
        self._params_dict["Y"] = {"type": "int", "value": 69, "text": "Y"}
        self._params_dict["sinoLable"] = {"type": "enum", "value": Sino_Type.unit1,
                                              "text": "Algorithm"}
        ...
        def run_function(self, data):
            ...
            sino, label = CTF.GenSino(X = self.get_param_value("X"),Y = self.get_param_value("Y"),
                                data = data['peakfit'][unit],Num = data['Image_num'])
...
class Recon2D(ProcessingFunction):
    ...
    def __init__(self):
        ...
        self._params_dict["BeamCenter"] = {"type": "float", "value": 34, "text": "Rotation Axis"}
